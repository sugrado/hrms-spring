...
public class QNQKPSPublicSoap {
    ...
    public QNQKPSPublicSoap() {
    }

    public QNQKPSPublicSoap(String url) {
        this.url = url;
    }

    public QNQKPSPublicSoap(String url, int timeOut) {
        this.url = url;
    ...
    protected QNQExtendedSoapSerializationEnvelope createEnvelope() {
        QNQExtendedSoapSerializationEnvelope envelope = new QNQExtendedSoapSerializationEnvelope(QNQExtendedSoapSerializationEnvelope.VER11);
