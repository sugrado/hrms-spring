...
public class QNQExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(QNQDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new QNQStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static QNQDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static QNQDateTimeConverter dateTimeConverter = new QNQStandardDateTimeConverter();

    public QNQExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public QNQExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new QNQMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=QNQHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,QNQExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=QNQHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
